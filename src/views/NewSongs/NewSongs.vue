    ...
    <div class="songs-table">
      <el-table :data="tableData" stripe style="width: 100%" @row-dblclick="play">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" @click="addfavorite(scope.row.id)">收藏</el-button>
...
export default {
  ...
  methods: {
      ...
      getNewSongsAPI().then(res => {
        ...
        for (const item of resultList) {
          ...
          let song = {
            ...
            imgUrl: item.songimgurl,
            duration,
            mp3Url: " http://music.163.com/song/media/outer/url?id=" + item.sid + " .mp3"
          } //
          console.log(song.mp3Url); songsList.push(song)
    ...
    play(row) {
      ...
      this.addlistenhistor(id);
      this.addsongcount(id);
